 ...
 * API Depricated
 */
@property(retain, nonatomic) NSString * hashedPhoneNumber;
 ...
 * API Depricated
 */
@property(retain, nonatomic) NSArray * hashedEmails;
 ...
 * </ul>
 */
@property(retain, nonatomic) NSString * income;
 ...
 */
@property(retain, nonatomic) NSArray * interests;
